...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_enqueue_style( 'custom-stylesheet', get_template_directory_uri() . '/assets/stylesheets/custom.css', array(), '1.0.0', 'all' );
	...
	wp_enqueue_script( 'custom', get_template_directory_uri() . '/assets/javascript/custom.js', array('jquery'), '1.0.0', true );
